...
- (id) initWithFrame:(CGRect)frame {
    ...
    if (self)
    {
        ...
        self.waveColor = [[UIColor whiteColor] colorWithAlphaComponent:1];
...
- (void) layoutSubviews {
    ...
    if (_waveImageView == nil)
    {
        ...
        _progressImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 1.0f, self.height)];
...
//    _progressImageView.width = _waveImageView.width * progress;
    [_progressImageView setFrame:CGRectMake(_waveImageView.width * progress, _progressImageView.frame.origin.y, _progressImageView.width, _progressImageView.height)];
